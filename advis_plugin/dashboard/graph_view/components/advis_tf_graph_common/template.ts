 ...
 *   Object with min level of the template and an Array of advis.graph.Group]
 *   sort by ascending order of minimum depth at which metanode appears.
 */
function clusterSimilarSubgraphs(h: hierarchy.Hierarchy) {
  /** a dict from metanode.signature() => Array of advis.graph.Groups */
...
function isSimilarSubgraph(g1: graphlib.Graph<any, any>,
  ...
  if (!advis.graph.hasSimilarDegreeSequence(g1, g2)) {
      return false;
  }
